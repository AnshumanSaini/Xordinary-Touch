...
# Status Variables
tool_ed, tool_sel, tool_color, bgr_color, tool_size, display_ed, undo_option = "No", "Brush", "(0,0,255)", "(0,0,0)", "1", "Enabled", "Not Available"
...
def create_Trackbars():
    ...
    cv2.setTrackbarPos("Bg Red", "Control Panel", 255)
    cv2.setTrackbarPos("Bg Green", "Control Panel", 255)
    cv2.setTrackbarPos("Bg Blue", "Control Panel", 255)
    cv2.setTrackbarPos("Main Feed", "Control Panel", 1)
...
if doonce == 0:
    ...
    cv2.putText(imgr, "...", (180, 330), cv2.FONT_HERSHEY_SIMPLEX, 1,
                (0, 255, 0), 2)
...
#
# low_b = np.uint8([0, 34, 250])
#         high_b = np.uint8([18, 220, 255])